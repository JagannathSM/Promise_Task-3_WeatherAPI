...
function daily_weather(daily,reset_val){
    ...
    col_2.className = "col-sm-12 reset current";
    ...
    for(var i=0; i<daily.length;i++){
        ...
        var daily_body_td2 = create_td(daily_temp);
...
function hourly_weather(hourly,reset_val){
    ...
    col_3.className = "col-sm-12 reset current";
    ...
    var tr11 = create_tr();
    var th11 = create_th("scope","col","Time");
    var th21 = create_th("scope","col","Precipitation");
    var th31 = create_th("scope","col","Temperature");
    var th41 = create_th("scope","col","Weather");
    var th51 = create_th("scope","col","Summary");
    ...
    for(var j=0;j<hourly.length;j++){
        ...
        var hourly_body_td2 = create_td(hourly_temp);
